...
int main(int argc, char* argv[]){
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        // Regular updates
        Input_listener::processInput(window, deltaTime); // Checks if a key is being pressed
        ...
        glm::mat4 projection = glm::perspective(glm::radians(45.0f), (float)width/(float)height, 0.1f, 100.0f); // Projection: project 3D view on 2D
